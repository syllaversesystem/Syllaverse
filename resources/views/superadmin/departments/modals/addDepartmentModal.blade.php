...
* Description: Modal for adding a new department with brand-aligned UI styling
-------------------------------------------------------------------------------
📜 Log:
[2025-10-02] Updated to match admin add course modal UI design - brand colors, improved styling, better form layout.
-------------------------------------------------------------------------------
--}}
...
<div class="modal fade sv-appt-modal" id="addDepartmentModal" tabindex="-1" aria-labelledby="addDepartmentModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <form action="{{ route('superadmin.departments.store') }}" method="POST" class="modal-content">
      @csrf
