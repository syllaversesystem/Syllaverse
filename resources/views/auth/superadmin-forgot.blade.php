    ...
    <div class="row justify-content-center">
      <div class="col-xl-6 col-lg-7 col-md-8">
        <div class="card shadow-sm border-0">
          <div class="card-body">
            <h6 class="fw-bold mb-2">Reset Admin Password</h6>
            <p class="text-muted mb-3">We’ll send a reset request to <strong>{{ $email }}</strong>.</p>
            ...
            <form method="POST" action="{{ route('superadmin.forgot.request') }}" class="mt-2">
              @csrf
