{{-- 
------------------------------------------------
* File: resources/views/admin/syllabus/modals/create.blade.php
* Description: Modal for creating a syllabus (admin) – Syllaverse
------------------------------------------------ 
--}}
...
<div class="modal fade" id="selectSyllabusMetaModal" tabindex="-1" aria-labelledby="selectSyllabusMetaModalLabel" aria-hidden="true">
  ...
  @php $rp = $routePrefix ?? 'admin.syllabi'; @endphp
