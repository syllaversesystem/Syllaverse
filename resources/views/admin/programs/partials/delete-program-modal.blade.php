  {{-- 
-------------------------------------------------------------------------------
* File: resources/views/admin/programs/partials/delete-program-modal.blade.php
* Description: Delete confirmation modal for Programs (AJAX-ready) - Standalone programs module
-------------------------------------------------------------------------------
📜 Log:
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content program-delete-form">
      ...
      <div class="modal-footer">
        ...
        <form id="deleteProgramForm" action="{{ route('admin.programs.destroy', 0) }}" method="POST" class="d-inline delete-program-form">
          @csrf
          @method('DELETE')
