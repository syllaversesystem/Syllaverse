{{-- 
-------------------------------------------------------------------------------
* File: resources/views/faculty/departments/modals/deleteDepartmentModal.blade.php
* Description: Delete confirmation modal for departments with brand-aligned UI styling (Faculty version)
-------------------------------------------------------------------------------
📜 Log:
[2025-01-16] Created faculty version based on admin delete department modal
-------------------------------------------------------------------------------
--}}
