{{-- 
-------------------------------------------------------------------------------
* File: resources/views/faculty/master-data/index.blade.php
* Description: Faculty Master Data Page – aligned with Manage Accounts UI (SO/ILO + Programs/Courses)
-------------------------------------------------------------------------------
📜 Log:
...
/* ============================================================================
   MODAL BACKDROP STYLES - Enhanced dim background
   ============================================================================ */
.modal {
...
{{-- ░░░ START: Shared Modals for SO, SDG, IGA, CDIO ░░░ --}}
@include('faculty.master-data.modals.shared-master-data-modal')
...
{{-- Programs: @see resources/views/faculty/programs/index.blade.php --}}
{{-- Courses: @see resources/views/faculty/courses/index.blade.php --}}
...
<script>
  ...
  // Modal setup functions for SDG/IGA/CDIO - handled by shared-master-data-modal.blade.php

  // setupEditModal and setupDeleteModal functions are handled by shared-master-data-modal.blade.php
</script>
