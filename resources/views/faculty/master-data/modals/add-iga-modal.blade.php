  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <form id="addIgaForm" method="POST" class="modal-content" action="{{ url('/faculty/master-data/iga') }}">
      ...
      <style>
        ...
        #addIgaModal .btn-danger:hover, #addIgaModal .btn-danger:focus{ background:linear-gradient(135deg, rgba(255,240,235,.88), rgba(255,255,255,.46)); box-shadow:0 4px 10px rgba(204,55,55,.12); color:#CB3737; }
        #addIgaModal .btn-light{ background:#fff; border:none; color:#6c757d; transition:all .2s ease; display:inline-flex; align-items:center; gap:.5rem; padding:.5rem 1rem; border-radius:.375rem; }
        #addIgaModal .btn-light:hover, #addIgaModal .btn-light:focus{ background:linear-gradient(135deg, rgba(220,220,220,.88), rgba(240,240,240,.46)); box-shadow:0 4px 10px rgba(108,117,125,.12); color:#495057; }
      </style>
