  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <form id="editSdgForm" method="POST" class="modal-content" action="#">
      ...
      <style>
        ...
        #editSdgModal .modal-title i, #editSdgModal .modal-title svg { width:1.05rem; height:1.05rem; stroke: var(--sv-text-muted,#777); }
        ...
        #editSdgModal .btn-danger i, #editSdgModal .btn-danger svg { stroke:#000; }
        #editSdgModal .btn-danger:hover, #editSdgModal .btn-danger:focus{ background:linear-gradient(135deg, rgba(235,235,235,.88), rgba(250,250,250,.46)); box-shadow:0 4px 10px rgba(0,0,0,.10); color:#000; }
        #editSdgModal .btn-danger:hover i, #editSdgModal .btn-danger:hover svg, #editSdgModal .btn-danger:focus i, #editSdgModal .btn-danger:focus svg { stroke:#000; }
        #editSdgModal .btn-light{ background:#fff; border:none; color:#000; transition:all .2s ease; display:inline-flex; align-items:center; gap:.5rem; padding:.5rem 1rem; border-radius:.375rem; }
        #editSdgModal .btn-light i, #editSdgModal .btn-light svg { stroke:#000; }
        #editSdgModal .btn-light:hover, #editSdgModal .btn-light:focus{ background:linear-gradient(135deg, rgba(225,225,225,.88), rgba(240,240,240,.46)); box-shadow:0 4px 10px rgba(0,0,0,.08); color:#000; }
        #editSdgModal .btn-light:hover i, #editSdgModal .btn-light:hover svg, #editSdgModal .btn-light:focus i, #editSdgModal .btn-light:focus svg { stroke:#000; }
      </style>
