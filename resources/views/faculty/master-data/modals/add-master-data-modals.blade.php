{{-- 
-------------------------------------------------------------------------------
* File: resources/views/faculty/master-data/modals/add-master-data-modals.blade.php
* Description: Add modals for SDG / IGA / CDIO – Faculty version
-------------------------------------------------------------------------------
📜 Log:
...
<div class="modal fade"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg"><!-- wider -->
    <div class="modal-content">
      <form action="{{ route('faculty.master-data.store', 'sdg') }}"
            method="POST"
...
<div class="modal fade"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg"><!-- wider -->
    <div class="modal-content">
      <form action="{{ route('faculty.master-data.store', 'iga') }}"
            method="POST"
            class="add-master-data-form">
        @csrf
...
<div class="modal fade"
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg"><!-- wider -->
    <div class="modal-content">
      <form action="{{ route('faculty.master-data.store', 'cdio') }}"
            method="POST"
            class="add-master-data-form">
        @csrf
