  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <style>
        ...
        #loadPredefinedSdgsModal .modal-header {
        ...
        #loadPredefinedSdgsModal .modal-title svg {
          width: 1.25rem;
          height: 1.25rem;
        }
        ...
        #loadPredefinedSdgsModal .alert {
          border-radius: 12px;
          border: 1px solid rgba(255, 193, 7, 0.3);
        }
        #loadPredefinedSdgsModal .alert-warning {
        ...
        #loadPredefinedSdgsModal .btn-danger svg {
          width: 1rem;
          height: 1rem;
        }
        ...
        #loadPredefinedSdgsModal .btn-danger:hover i,
        #loadPredefinedSdgsModal .btn-danger:hover svg,
        #loadPredefinedSdgsModal .btn-danger:focus i,
        #loadPredefinedSdgsModal .btn-danger:focus svg {
          stroke: #CB3737;
        }
        #loadPredefinedSdgsModal .btn-danger:active {
          transform: scale(0.98);
        }
        #loadPredefinedSdgsModal .btn-danger:active i,
        #loadPredefinedSdgsModal .btn-danger:active svg {
          stroke: #CB3737;
        }
        #loadPredefinedSdgsModal .form-check-input {
          background-color: #E8E8E8;
          border-color: #CCCCCC;
        }
        #loadPredefinedSdgsModal .form-check-input:checked {
          background-color: #6C757D;
          border-color: #6C757D;
        }
        #loadPredefinedSdgsModal .form-check-input:focus {
          border-color: #999999;
