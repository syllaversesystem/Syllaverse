// -----------------------------------------------------------------------------
// * File: resources/js/faculty/master-data/ilo.js
...
function initSortable(tbody, saveBtn) {
  ...
  activeSaveBtn.addEventListener('click', async () => {
    ...
    try {
      const reorderUrl = activeSaveBtn.getAttribute('data-reorder-url') || '/faculty/master-data/reorder/ilo';
...
async function fetchIlos(courseId) {
  const res = await fetch(`/faculty/master-data/ilos?course_id=${encodeURIComponent(courseId)}`, {
...
function bootEdit() {
  document.addEventListener('click', (e) => {
    ...
    $('#editIloForm')?.setAttribute('action', `/faculty/master-data/ilo/${id}`);
...
function bootDelete() {
  document.addEventListener('click', (e) => {
    ...
    $('#deleteIloForm')?.setAttribute('action', `/faculty/master-data/ilo/${id}`);
