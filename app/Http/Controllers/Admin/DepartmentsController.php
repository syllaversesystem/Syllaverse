...
class DepartmentsController extends Controller
{
    ...
    public function index(): View
    {
        try {
            ...
            return view('admin.departments.index', ['departments' => collect()]);
        }
    }
     ...
     */
    public function getTableContent(): JsonResponse
    {
        try {
            $departments = Department::orderBy('name')->get();
            
            $html = view('admin.departments.partials.table-content', compact('departments'))->render();
